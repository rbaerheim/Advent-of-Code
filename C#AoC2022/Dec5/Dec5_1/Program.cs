...
foreach (string line in enumLines)
{
    ...
    // Reverses the letters in the array to simulate we are moving from the top and to another stack
    Array.Reverse(lettersToMoveToCharArray);
...
Console.WriteLine(combinedAnswer); // LBLVVTVLP
