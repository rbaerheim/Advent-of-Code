...
class Program
{
    static void Main(string[] args)
    {
        ...
        // Looping over and counting each directory value below 100000 and adding them to total.
        ...
        Console.WriteLine(totalScore); // 1307902

        // Stops the benchmarking and prints it to the console.
        watch.Stop();
        Console.WriteLine(watch.ElapsedMilliseconds); // 17
